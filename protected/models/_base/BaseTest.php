...
abstract class BaseTest extends CActiveRecord {
    ...
    public function rules() {
        return array(
            array('birthdate, birthtime, status, slogan, content, image, email, uri, qualification', 'required'),
            ...
            array('id, name, birthdate, birthtime, enabled, status, slogan, content, created_at, changed_at, image, email, uri, qualification', 'safe', 'on' => 'search'),
        );
    }
