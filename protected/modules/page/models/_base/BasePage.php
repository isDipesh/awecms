...
abstract class BasePage extends GxActiveRecord {
	...
	public function rules() {
		return array(
			array('title, content, created_at, modified_at, parent, password', 'required'),
			array('author, parent, order', 'numerical', 'integerOnly'=>true),
			array('status, type, comment_status, permission, password', 'length', 'max'=>20),
			array('excerpt', 'safe'),
			array('author, excerpt, status, order, type, comment_status, permission', 'default', 'setOnEmpty' => true, 'value' => null),
