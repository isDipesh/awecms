...
array(
			'name' => 'author0',
			'type' => 'raw',
			'value' => $model->author0 !== null ? GxHtml::link(GxHtml::encode(GxHtml::valueEx($model->author0)), array('user/view', 'id' => GxActiveRecord::extractPkValue($model->author0, true))) : null,
			),
'title',
'content',
'excerpt',
