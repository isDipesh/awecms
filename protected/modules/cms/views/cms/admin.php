...
$this->menu = array(
    array('label' => 'Add Page', 'url' => array('create', 'type' => Cms::PAGE, 'parent_id' => $parent_id)),
    array('label' => 'Add Set of Pages', 'url' => array('create', 'type' => Cms::PAGESET, 'parent_id' => $parent_id)),
