...
class AtNestedSortable extends CWidget
{
    ...
    //	Yii::app()->clientScript->registerCssFile('/libs/nestedsortable/nestedSortable.css');
    	Yii::app()->clientScript->registerScriptFile('/libs/nestedsortable/jquery.ui.nestedSortable.js');
    }
